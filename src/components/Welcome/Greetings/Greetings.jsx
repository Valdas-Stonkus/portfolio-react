...
const Greetings = () => (
    <>
        ...
        <Typography variant="h5" component="h5" mt={2} sx={{ fontSize: '1rem' }}>
            I am based in Šiauliai, Lithuania. I have more that 1 year experience of creating web applications. I am open for new opportunities and interesting projects.
        </Typography>
